...
def get_subdirectorys(directory:"StrPath")->"list[str]":
    """return the name of all the directorys inside the targeted directory"""
...
def get_subfiles(directory:"StrPath")->"list[str]":
    """return the name of all the files inside the targeted directory"""
...
def get_subfilesAndDirs(directory:"StrPath")->"list[str]":
    """return the name of all the directorys and files inside the targeted directory"""
